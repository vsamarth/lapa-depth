...
python3 -u -m latent_pretraining.train \
    ...
    --update_llama_config="dict(action_vocab_size=245,delta_vocab_size=8,theta=50000000,max_sequence_length=512,use_flash_attention=True,scan_attention=True,scan_query_chunk_size=128,scan_key_chunk_size=1024,remat_attention='nothing_saveable',scan_mlp=True,scan_mlp_chunk_size=8192,remat_mlp='nothing_saveable',remat_block='nothing_saveable',scan_layers=True)" \
    ...
    --train_dataset.json_delta_action_dataset.seq_length=192 \
    --train_dataset.json_delta_action_dataset.batch_size=1 \
