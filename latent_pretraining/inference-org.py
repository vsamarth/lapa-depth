...
if __name__ == "__main__":
    ...
    for i in range(100):    
        ...
        print("latent action is", i, latent_action)
        # print("latent action is.shape", latent_action.shape)

        z_rgb = lapa.model.delta_ids_to_embedding(latent_action, reshape_to_grid=True)

        print("z_rgb shape:", z_rgb.shape)
        print("z_rgb dtype:", z_rgb.dtype)
