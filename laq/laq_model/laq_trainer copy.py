...
class LAQTrainer(nn.Module):
    ...
    def train_step(self):
        ...
        for _ in range(self.grad_accum_every):
            ...
            # rgb, depth = next(self.dl_iter)
            # img = self._select_input(rgb, depth, device)
            ...
            # print("rgb, depth, z_rgb: ", rgb.shape, depth.shape, z_rgb.shape) 
        ...
        if self.is_main and not (steps % self.save_results_every):
            ...
            for model, filename in vaes_to_evaluate:
                ...
                # valid_rgb, valid_depth = next(self.valid_dl_iter)
                ...
                # print("valid_rgb, valid_depth, z_rgb : ", valid_rgb.shape, valid_depth.shape, z_rgb.shape) 
        ...
        if self.is_main and not (steps % self.save_model_every):
            ...
            adapter_path = str(self.results_folder / f'adapter.{steps}.pt')
            self.save_adapter_only(adapter_path)
